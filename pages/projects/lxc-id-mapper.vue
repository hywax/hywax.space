<template>
  <article class="prose m-a">
    ...
    <a href="https://github.com/hywax/lxc-idmapper" target="_blank" rel="nofollow"><span class="i-uil:github-alt" /> {{ $t('projects.view.github') }}</a>
    <a href="https://www.npmjs.com/package/lxc-idmapper" target="_blank" rel="nofollow" class="ml-3"><span class="i-teenyicons:npm-solid" /> {{ $t('projects.view.npm') }}</a>
